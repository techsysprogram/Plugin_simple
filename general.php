...
function executer_funcion_tech01()
{
    // Load plugin files.
    include "table.php";
}
add_shortcode('short_checkbox', 'executer_funcion_tech01');
// [short_checkbox] esto seria el nombre del short code pour elementor


// Enregistre le script JavaScript
function my_custom_scripts() {
    wp_enqueue_script( 'mon-plugin-script', plugin_dir_url( __FILE__ ) . 'js/main.js', array( 'jquery' ), '1.0', true );
}
